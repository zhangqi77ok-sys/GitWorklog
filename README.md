...
## 🚨 项目级三大铁律 (Project-Level Iron Rules)

1. **双向强同步**：凡有需求、原型、功能的变更，**一定要同时同步到需求 PRD (`docs/`) 和原型工程 (`prototype/`) 里**；
2. **严禁越界开发**：**没有进行需求澄清和原型设计，绝对不准进行项目开发**；
3. **真交互原型**：**涉及到功能的原型一定要有真实可点击、可流转的交互页面**。
